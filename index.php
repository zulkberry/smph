...
$query = "select izin.*, guru.nama as nama_guru, bk.nama as nama_bk
        ...
        where siswa_id = 2";
        // jalankan query di di phpmy admin unyuk ujicoba sql
//3. Menjalankan query
$sql = mysqli_query($is_connect, $query);
//var_dum($sql); -> gunakan var_dump untuk menguji variable isinya apa aja
?>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
                ...
                <div class="card overflow-hidden">
                  <div class="card-body p-4">
                    ...
                    <div class="row align-items-center">
                      <div class="col-8">
                        <h4 class="fw-semibold mb-3">9 Hari</h4>
        ...
        <div class="py-6 px-6 text-center">
          <p class="mb-0 fs-4">Design and Developed by <a href="https://sija-bridge.tech" target="_blank" class="pe-1 text-primary text-decoration-underline">sija-bridge.tech</a></p>
        </div>
      </div>
    </div>
  </div>
